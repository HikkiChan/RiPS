...
public class Tariff {
     ...
     * @see Tariff#Tariff()
     */
    Tariff(int subscriptionFee, int costMinuteInNW, int costMinuteInOtherNW,
                  int costSms, int costInternet, Species species) {
    ...
    public String toString() {
        return "Cost subscription fee = "+ subscriptionFee +", Cost minute in NW = " + costMinuteInNW +
                ", Cost minute in other NW = " + costMinuteInOtherNW + ", Cost sms = " + costSms +
                ", Cost internet traffic = " + costInternet + ", Tariff plan = " + species;
    }
}
